...
export const ROUTINES: Routine[] = [
  {
    ...
    items: [
      { title: 'Potty break', type: 'other', hourOfDay: 7, repeatType: 'daily', notes: 'Take outside first thing in the morning.' },
      { title: 'Potty break', type: 'other', hourOfDay: 12, repeatType: 'daily', notes: 'Midday outdoor break.' },
      { title: 'Potty break', type: 'other', hourOfDay: 18, repeatType: 'daily', notes: 'Evening break before settling.' },
      { title: 'Crate practice', type: 'training', hourOfDay: 10, repeatType: 'daily', notes: 'Short, positive crate session (5–10 min).' },
      { title: 'Sit / stay session', type: 'training', hourOfDay: 16, repeatType: 'daily', notes: 'Two or three 2-minute reps with treats.' },
      { title: 'Socialization outing', type: 'other', hourOfDay: 15, repeatType: 'weekly', notes: 'New place, person, or surface this week.' },
    ],
  },
  {
    id: 'puppy_growing',
    ...
    items: [
      ...
      { title: 'Recall practice', type: 'training', hourOfDay: 11, repeatType: 'daily', notes: 'Call from a short distance with treats.' },
      { title: '"Wait" at the door', type: 'training', hourOfDay: 17, repeatType: 'daily', notes: 'Practice impulse control before going outside.' },
      { title: 'Chew toy rotation', type: 'other', hourOfDay: 9, repeatType: 'weekly', notes: 'Swap chew toys to keep them novel.' },
  ...
  },
  {
    ...
    items: [
      { title: 'Litter box check', type: 'other', hourOfDay: 8, repeatType: 'daily', notes: 'Scoop and refresh.' },
      { title: 'Play session', type: 'other', hourOfDay: 17, repeatType: 'daily', notes: 'Wand or feather toy, 10 minutes.' },
      { title: 'Scratching post training', type: 'training', hourOfDay: 11, repeatType: 'daily', notes: 'Reward when they use it.' },
      { title: 'Carrier desensitization', type: 'training', hourOfDay: 14, repeatType: 'weekly', notes: 'Leave carrier out, drop treats inside.' },
  ...
  },
  {
    ...
    items: [
      { title: 'Litter box', type: 'other', hourOfDay: 9, repeatType: 'daily', notes: 'Scoop daily.' },
      { title: 'Play session', type: 'other', hourOfDay: 19, repeatType: 'daily', notes: 'Interactive play helps prevent boredom.' },
      { title: 'Brush', type: 'grooming', hourOfDay: 20, repeatType: 'weekly', notes: 'Reduces shedding and hairballs.' },
      { title: 'Weight + body check', type: 'other', hourOfDay: 10, repeatType: 'monthly', notes: 'Run hands along ribs and spine, log weight.' },
    ],
  },
];
